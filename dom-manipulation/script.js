// ===== Task 3: Syncing Data with Server and Conflict Resolution (Final Version) =====
...
// --- Post new quote to mock API (POST logic) ---
...
async function syncWithServer() {
  ...
  notification.textContent = "Sync complete. Server data prioritized.";
